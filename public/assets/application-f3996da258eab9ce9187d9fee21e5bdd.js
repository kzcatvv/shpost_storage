...
(function() {
  ...
  ready = function() {
    brsid();
    return $("#relationship_supplier_id").change(brsid);
  };

  brsid = function() {
    var brid, indexs, s, surl, url;
    ...
    if (surl !== void 0) {
      ...
      return $('#br_specification_name').attr("data-autocomplete", url);
    }
  };
...
(function() {
  ...
  ready = function() {
    ...
    return $('#query_order_end_date_query_order_end_date').datepicker({
      changeMonth: true,
      changeYear: true
    });
  };
...
(function() {
  ...
  ready = function() {
    kosid();
    return $("#keyclientorderdetail_supplier_id").change(kosid);
  };

  kosid = function() {
    var indexs, koid, s, surl, url;
    ...
    if (surl !== void 0) {
      ...
      return $('#ko_specification_name').attr('data-autocomplete', url);
    }
  };
...
(function() {
  ...
  ready = function() {
    mssid();
    return $("#manual_stock_detail_supplier_id").change(mssid);
  };

  mssid = function() {
    var indexs, msid, s, surl, url;
    ...
    if (surl !== void 0) {
      ...
      return $('#ms_specification_name').attr('data-autocomplete', url);
    }
  };
...
(function() {
  ...
  ready = function() {
    ossid();
    return $("#order_detail_supplier_id").change(ossid);
  };

  ossid = function() {
    var indexs, osid, s, surl, url;
    ...
    if (surl !== void 0) {
      ...
      return $('#os_specification_name').attr('data-autocomplete', url);
    }
  };
...
(function() {
  ...
  ready = function() {
    return $("#tracking_number").keypress(enterpress);
  };
...
(function() {
  ...
  ready = function() {
    pdsid();
    return $('#purchase_detail_supplier_id').change(pdsid);
  };

  pdsid = function() {
    var indexs, s, supplier_id, surl, url;
    ...
    if (surl !== void 0) {
      ...
      return $("#pd_specification_name").attr("data-autocomplete", url);
    }
  };
...
(function() {
  var ajaxunitselect, ready, setautobusinessid, setautostorageid, setautosupplierid;
  ...
  ready = function() {
    ...
    return $("#org_stocks_import_supplier").change(setautosupplierid);
  };

  ajaxunitselect = function() {
    return $.ajax({
      type: 'GET',
      url: '/up_downloads/select_unit/',
      data: {
        unit_id: $('#org_stocks_import_unit').val()
      },
      dataType: 'script'
    });
  };

  setautostorageid = function() {
    var indexs, s, stoid, surl, url;
    ...
    if (surl !== void 0) {
      ...
      return $('#org_stocks_import_shelf_code').attr("data-autocomplete", url);
    }
  };

  setautobusinessid = function() {
    var indexs, s, sibuid, surl, url;
    ...
    if (surl !== void 0) {
      ...
      return $('#org_stocks_import_specificaion').attr("data-autocomplete", url);
    }
  };

  setautosupplierid = function() {
    var indexs, s, sisuid, surl, url;
...
function hot_gnxb() {
  LODOP.PRINT_INITA("-2.6mm","-11.1mm","232.8mm","160.1mm","tracking");
  LODOP.SET_PRINT_PAGESIZE(1,1000,1500,"tracking");
  LODOP.ADD_PRINT_TEXT("2.9mm","12.4mm","32.5mm","10.6mm","国内小包");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.SET_PRINT_STYLEA(0,"FontSize",20);
  LODOP.ADD_PRINT_TEXT(55,55,100,26,"(代收货款)");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.SET_PRINT_STYLEA(0,"FontSize",13);
  LODOP.ADD_PRINT_BARCODE(13,180,230,67,"","123456789012");
  LODOP.ADD_PRINT_LINE(82,44,83,404,0,1);
  LODOP.ADD_PRINT_LINE(105,42,104,407,0,1);
  LODOP.ADD_PRINT_LINE(192,73,105,74,0,1);
  LODOP.ADD_PRINT_TEXT(113,43,29,25,"收");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.SET_PRINT_STYLEA(0,"FontSize",11);
  LODOP.ADD_PRINT_TEXT(147,43,27,25,"件");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.SET_PRINT_STYLEA(0,"FontSize",11);
  LODOP.ADD_PRINT_TEXT(108,84,75,25,"新加文本11");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.ADD_PRINT_LINE(193,40,192,411,0,1);
  LODOP.ADD_PRINT_LINE(356,232,192,233,0,1);
  LODOP.ADD_PRINT_TEXT(194,43,56,20,"订单号:");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.ADD_PRINT_TEXT(195,106,115,20,"新加文本15");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.ADD_PRINT_TEXT(216,42,55,20,"品名:");
  LODOP.ADD_PRINT_TEXT(217,106,115,105,"新加文本17");
  LODOP.ADD_PRINT_TEXT(109,195,158,20,"新加文本18");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.ADD_PRINT_TEXT(140,84,316,42,"新加文本19");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.ADD_PRINT_TEXT(322,42,65,20,"重量(克):");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.ADD_PRINT_TEXT(323,114,100,20,"新加文本21");
  LODOP.ADD_PRINT_TEXT(195,236,116,20,"收件人/代收人:");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.SET_PRINT_STYLEA(0,"FontSize",10);
  LODOP.ADD_PRINT_TEXT(296,240,100,25,"签收时间:");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.ADD_PRINT_TEXT(324,302,20,20,"年");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.ADD_PRINT_TEXT(324,340,20,20,"月");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.ADD_PRINT_TEXT(325,376,22,20,"日");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.ADD_PRINT_LINE(357,50,356,411,2,1);
  LODOP.ADD_PRINT_BARCODE(360,52,207,60,"Code39","123456789012");
  LODOP.ADD_PRINT_LINE(425,46,424,413,0,1);
  LODOP.ADD_PRINT_TEXT(426,52,26,40,"收\n件");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
  LODOP.ADD_PRINT_LINE(543,85,425,86,0,1);
  LODOP.ADD_PRINT_LINE(478,46,477,418,0,1);
  LODOP.ADD_PRINT_TEXT(480,51,27,44,"寄\n件");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.SET_PRINT_STYLEA(0,"FontSize",12);
  LODOP.ADD_PRINT_TEXT(426,89,100,20,"新加文本34");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.ADD_PRINT_TEXT(427,200,100,20,"新加文本35");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.ADD_PRINT_TEXT(447,89,313,30,"新加文本36");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.ADD_PRINT_TEXT(479,88,100,20,"新加文本37");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.ADD_PRINT_TEXT(480,198,100,20,"新加文本38");
  LODOP.ADD_PRINT_TEXT(500,89,206,32,"新加文本39");
  LODOP.ADD_PRINT_LINE(544,49,543,298,0,1);
  LODOP.ADD_PRINT_LINE(589,300,477,301,0,1);
  LODOP.ADD_PRINT_TEXT(545,50,52,20,"订单号:");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
  LODOP.ADD_PRINT_TEXT(545,105,183,20,"新加文本44");
  LODOP.ADD_PRINT_LINE(569,52,568,300,0,1);
  LODOP.ADD_PRINT_TEXT(570,52,250,20,"网址:www.chinapost.com.cn 客服电话:1...(省略)");
  LODOP.SET_PRINT_STYLEA(0,"FontName","黑体");
...
LODOP.ADD_PRINT_IMAGE(14,7,92,34,"<img border='0' src='http://127.0.0.1:3000/gjlogo.png' />");
LODOP.ADD_PRINT_TEXT(20,179,145,20,"Small Packet BY AIR");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_BARCODE(284,146,206,44,"",'<%= eorder.tracking_number %>');
LODOP.ADD_PRINT_RECT(3,5,363,544,0,1);
LODOP.ADD_PRINT_TEXT(60,10,41,20,"From:");
LODOP.ADD_PRINT_TEXT(83,10,129,93,'<%= eorder.send_province %><%= eorder.send_city %><%= eorder.send_addr %>');
LODOP.ADD_PRINT_TEXT(180,11,61,20,"Phone:");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(203,11,130,30,'<%= eorder.send_mobile %>');
LODOP.ADD_PRINT_LINE(47,142,46,367,0,1);
LODOP.ADD_PRINT_LINE(47,141,280,142,0,1);
LODOP.ADD_PRINT_LINE(244,7,243,142,0,1);
LODOP.ADD_PRINT_TEXT(248,9,43,25,"编号:");
LODOP.ADD_PRINT_TEXT(249,53,85,25,'<%= eorder.tracking_number %>');
LODOP.ADD_PRINT_TEXT(48,143,70,20,"Ship To:");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(69,143,222,152,'<%= eorder.province %><%= eorder.city %><%= eorder.customer_address %>');
LODOP.ADD_PRINT_TEXT(225,144,54,20,"Phone:");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(246,143,224,30,'<%= eorder.customer_phone %>');
LODOP.ADD_PRINT_LINE(331,7,330,367,0,1);
LODOP.ADD_PRINT_TEXT(334,30,175,20,"Description of Contents");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_LINE(356,7,355,367,0,1);
LODOP.ADD_PRINT_TEXT(333,252,27,20,"kg.");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(332,290,76,20,"Val(US $)");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
content='';
<% eorder.order_details.each do |j| %>
content=content+'<%= j.name.nil? ? j.specification.all_name : j.name %>            <%= j.weight.nil? ? j.specification.weight : j.weight %>  <%= j.price.nil? ? j.specification.price : j.price %>\n'
<% end %>
LODOP.ADD_PRINT_LINE(458,7,457,367,0,1);
LODOP.ADD_PRINT_LINE(483,6,482,366,0,1);
LODOP.ADD_PRINT_TEXT(358,8,357,97,content);
LODOP.ADD_PRINT_TEXT(460,12,352,20,"Total Gross Weight (Kg)");
LODOP.ADD_PRINT_LINE(331,288,481,289,0,1);
LODOP.ADD_PRINT_LINE(331,246,481,247,0,1);
LODOP.ADD_PRINT_TEXT(485,9,354,37,"I certify that the particulars given in this declaration are correct and this item does not contain any dangerous articles prohibited by legislation or by postal or customers regulations.");
LODOP.SET_PRINT_STYLEA(0,"FontSize",7);
LODOP.ADD_PRINT_LINE(281,6,280,366,0,1);
LODOP.ADD_PRINT_TEXT(289,11,120,31,"untracked");
LODOP.SET_PRINT_STYLEA(0,"FontSize",16);
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_LINE(5,325,45,326,0,1);
LODOP.ADD_PRINT_TEXT(523,10,204,20,"Sender's signiture& Data Signed:");
LODOP.SET_PRINT_STYLEA(0,"FontSize",7);
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_IMAGE(14,99,80,25,"<img border='0' src='http://127.0.0.1:3000/gjwish.png' />");
...
LODOP.ADD_PRINT_IMAGE(4,0,92,30,"<img border='0' src='http://127.0.0.1:3000/gjlogo.png' />");
LODOP.ADD_PRINT_TEXT(34,15,130,20,"Small Packet BY AIR");
LODOP.SET_PRINT_STYLEA(0,"FontSize",7);
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_BARCODE(16,175,184,60,"",'<%= eorder.tracking_number %>');
LODOP.ADD_PRINT_RECT(0,0,364,500,0,1);
LODOP.ADD_PRINT_RECT(57,55,41,33,0,1);
LODOP.ADD_PRINT_TEXT(61,58,33,26,"");
LODOP.ADD_PRINT_TEXT(91,2,41,20,"From:");
LODOP.ADD_PRINT_TEXT(112,2,145,88,'<%= eorder.send_province %><%= eorder.send_city %><%= eorder.send_addr %>');
LODOP.ADD_PRINT_TEXT(201,3,61,20,"Phone:");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(222,2,146,30,'<%= eorder.send_mobile %>');
LODOP.ADD_PRINT_LINE(82,151,81,361,0,1);
LODOP.ADD_PRINT_LINE(82,150,282,151,0,1);
LODOP.ADD_PRINT_LINE(254,1,253,151,0,1);
LODOP.ADD_PRINT_TEXT(255,2,43,25,"编号:");
LODOP.ADD_PRINT_TEXT(255,47,101,25,'<%= eorder.tracking_number %>');
LODOP.ADD_PRINT_TEXT(84,153,70,20,"Ship To:");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(105,151,210,121,'<%= eorder.province %><%= eorder.city %><%= eorder.customer_address %>');
LODOP.ADD_PRINT_TEXT(226,153,54,20,"Phone:");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(249,151,209,30,'<%= eorder.customer_phone %>');
LODOP.ADD_PRINT_LINE(282,2,281,362,0,1);
LODOP.ADD_PRINT_TEXT(283,11,180,20,"Description of Contents");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_LINE(306,2,305,362,0,1);
LODOP.ADD_PRINT_TEXT(283,244,32,20,"kg.");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(283,289,74,20,"Val(US $)");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_LINE(408,2,407,362,0,1);
LODOP.ADD_PRINT_LINE(433,2,432,362,0,1);
content='';
<% eorder.order_details.each do |j| %>
content=content+'<%= j.name.nil? ? j.specification.all_name : j.name %>            <%= j.weight.nil? ? j.specification.weight : j.weight %>  <%= j.price.nil? ? j.specification.price : j.price %>\n'
<% end %>
LODOP.ADD_PRINT_TEXT(308,3,355,97,content);
LODOP.ADD_PRINT_TEXT(410,3,356,20,"Total Gross Weight (Kg)");
LODOP.ADD_PRINT_LINE(282,282,427,283,0,1);
LODOP.ADD_PRINT_LINE(282,237,427,238,0,1);
LODOP.ADD_PRINT_TEXT(436,2,358,38,"I certify that the particulars given in this declaration are correct and this item does not contain any dangerous articles prohibited by legislation or by postal or customers regulations.");
LODOP.SET_PRINT_STYLEA(0,"FontSize",7);
LODOP.ADD_PRINT_TEXT(476,2,203,22,"Sender's signiture& Data Signed:");
LODOP.SET_PRINT_STYLEA(0,"FontSize",7);
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_IMAGE(4,92,80,30,"<img border='0' src='http://127.0.0.1:3000/gjwish.png' />");
