...
LODOP.ADD_PRINT_IMAGE(14,14,137,34,"<img border='0' src='http://127.0.0.1:3000/gjlogo.png' />");
LODOP.ADD_PRINT_TEXT(20,190,150,20,"Small Packet BY AIR");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_BARCODE(288,157,279,44,"","123456789012");
LODOP.ADD_PRINT_RECT(9,6,444,579,0,1);
LODOP.ADD_PRINT_TEXT(60,10,41,20,"From:");
LODOP.ADD_PRINT_TEXT(83,10,156,93,"新加文本11");
LODOP.ADD_PRINT_TEXT(180,11,61,20,"Phone:");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(203,11,156,30,"新加文本13");
LODOP.ADD_PRINT_LINE(47,179,46,450,0,1);
LODOP.ADD_PRINT_LINE(47,179,280,180,0,1);
LODOP.ADD_PRINT_LINE(244,7,243,179,0,1);
LODOP.ADD_PRINT_TEXT(248,9,43,25,"编号:");
LODOP.ADD_PRINT_TEXT(249,53,121,25,"新加文本18");
LODOP.ADD_PRINT_TEXT(50,184,70,20,"Ship To:");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(72,184,255,152,"新加文本20");
LODOP.ADD_PRINT_TEXT(228,185,54,20,"Phone:");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(248,185,252,30,"新加文本22");
LODOP.ADD_PRINT_LINE(345,7,344,449,0,1);
LODOP.ADD_PRINT_TEXT(347,62,180,20,"Description of Contents");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_LINE(372,7,371,450,0,1);
LODOP.ADD_PRINT_TEXT(347,322,27,20,"kg.");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(347,371,74,20,"Val(US $)");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_LINE(472,7,471,450,0,1);
LODOP.ADD_PRINT_LINE(500,6,499,449,0,1);
LODOP.ADD_PRINT_TEXT(373,8,438,97,"新加文本30");
LODOP.ADD_PRINT_TEXT(475,12,434,20,"Total Gross Weight (Kg)");
LODOP.ADD_PRINT_LINE(345,359,500,360,0,1);
LODOP.ADD_PRINT_LINE(344,310,499,311,0,1);
LODOP.ADD_PRINT_TEXT(502,9,437,47,"I certify that the particulars given in this declaration are correct and this item does not contain any dangerous articles prohibited by legislation or by postal or customers regulations.");
LODOP.ADD_PRINT_LINE(281,6,280,448,0,1);
LODOP.ADD_PRINT_TEXT(301,11,120,31,"untracked");
LODOP.SET_PRINT_STYLEA(0,"FontSize",16);
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_LINE(10,346,45,347,0,1);
LODOP.ADD_PRINT_TEXT(549,10,214,25,"Sender's signiture& Data Signed:");
...
LODOP.ADD_PRINT_IMAGE(14,14,137,34,"<img border='0' src='http://127.0.0.1:3000/gjlogo.png' />");
LODOP.ADD_PRINT_TEXT(57,15,150,20,"Small Packet BY AIR");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(16,180,34,52,"R");
LODOP.SET_PRINT_STYLEA(0,"FontSize",35);
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_BARCODE(16,228,225,60,"","123456789012");
LODOP.ADD_PRINT_RECT(4,6,444,579,0,1);
LODOP.ADD_PRINT_RECT(85,55,61,39,0,1);
LODOP.ADD_PRINT_TEXT(91,62,43,28,"新加文本9");
LODOP.ADD_PRINT_TEXT(126,10,41,20,"From:");
LODOP.ADD_PRINT_TEXT(150,10,156,88,"新加文本11");
LODOP.ADD_PRINT_TEXT(240,11,61,20,"Phone:");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(262,12,156,30,"新加文本13");
LODOP.ADD_PRINT_LINE(96,179,95,450,0,1);
LODOP.ADD_PRINT_LINE(95,179,345,180,0,1);
LODOP.ADD_PRINT_LINE(303,7,302,179,0,1);
LODOP.ADD_PRINT_TEXT(306,9,43,25,"编号:");
LODOP.ADD_PRINT_TEXT(306,53,121,25,"新加文本18");
LODOP.ADD_PRINT_TEXT(98,184,70,20,"Ship To:");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(121,184,255,152,"新加文本20");
LODOP.ADD_PRINT_TEXT(281,185,54,20,"Phone:");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_TEXT(304,185,252,30,"新加文本22");
LODOP.ADD_PRINT_LINE(345,7,344,449,0,1);
LODOP.ADD_PRINT_TEXT(347,62,180,20,"Description of Contents");
LODOP.SET_PRINT_STYLEA(0,"Bold",1);
LODOP.ADD_PRINT_LINE(372,7,371,450,0,1);
...
LODOP.ADD_PRINT_LINE(345,359,500,360,0,1);
LODOP.ADD_PRINT_LINE(344,310,499,311,0,1);
LODOP.ADD_PRINT_TEXT(500,9,437,48,"I certify that the particulars given in this declaration are correct and this item does not contain any dangerous articles prohibited by legislation or by postal or customers regulations.");
LODOP.ADD_PRINT_TEXT(551,10,263,25,"Sender's signiture& Data Signed:");
