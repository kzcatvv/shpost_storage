class StockLog < ActiveRecord::Base
  ...
  OPERATION = {create_stock: 'create_stock', destroy_stock: 'destroy_stock', update_stock: 'update_stock', purchase_stock_in: 'purchase_stock_in', b2c_stock_out: 'b2c_stock_out', b2b_stock_out: 'b2b_stock_out', order_return: 'order_return',order_bad_return: 'order_bad_return',move_to_bad: 'move_to_bad',bad_stock_in: 'bad_stock_in',move_stock_out: 'move_stock_out',move_stock_in: 'move_stock_in',inventory: 'inventory',b2c_pick_in: 'b2c_pick_in',b2c_pick_out: 'b2c_pick_out'}
  OPERATION_SHOW = {create_stock: '新建库存', destroy_stock: '删除库存', update_stock: '更新库存', purchase_stock_in: '采购入库', b2c_stock_out: '订单出库', b2b_stock_out: '批量出库', order_return: '退货',order_bad_return: '残次品退货',move_to_bad: '残次品移入',bad_stock_in: '残次品入库',move_stock_out: '货品移出',move_stock_in: '货品移入',b2c_pick_in: '拣货区移入',b2c_pick_out: '拣货区出库'}
