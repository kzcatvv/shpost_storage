class BusinessRelationshipController < ApplicationController
  load_and_authorize_resource :business
  load_and_authorize_resource :relationship, through: :business, parent: false
  def index
  ...
  def create
    ...
    respond_to do |format|
      if @relationship.save
        ...
        format.html { redirect_to business_relationship_path(@business,@relationship), notice: I18n.t('controller.create_success_notice', model: '对应关系')}
  ...
  def update
    respond_to do |format|
      if @relationship.update(relationship_params)
        ...
        format.html { redirect_to business_relationship_path(@business,@relationship), notice: I18n.t('controller.update_success_notice', model: '对应关系')}
  ...
  def destroy
    ...
    respond_to do |format|
      ...
      format.html { redirect_to business_relationships_path(@business) }
      format.json { head :no_content }
    end
  end
