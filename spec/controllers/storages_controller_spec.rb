  ...
  describe "POST create" do
    ...
    describe "with invalid params" do
      it "assigns a newly created but unsaved storage as @storage" do
        ...
        post :create, {:storage => { "name" => "invalid value" }}, valid_session
        assigns(:storage).should be_a_new(Storage)
      end
  ...
  describe "PUT update" do
    describe "with valid params" do
      it "updates the requested storage" do
        ...
        Storage.any_instance.should_receive(:update).with({ "name" => "MyString" })
        put :update, {:id => storage.to_param, :storage => { "name" => "MyString" }}, valid_session
      end
    ...
    describe "with invalid params" do
      it "assigns the storage as @storage" do
        ...
        # Trigger the behavior that occurs when invalid params are submitted
        Storage.any_instance.stub(:save).and_return(false)
        put :update, {:id => storage.to_param, :storage => { "name" => "invalid value" }}, valid_session
        assigns(:storage).should eq(storage)
      end
